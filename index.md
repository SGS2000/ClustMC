...
- Inspired by the [agricolae](https://myaseen208.com/agricolae/)
  ...
  [`aov()`](https://rdrr.io/r/stats/aov.html)). In the latter case, the
  name of the variable with the treatments must be specified.
...
- By default, a dendrogram is plotted. The dendrogram can be customized
  with any argument passed to the
  [`plot()`](https://rdrr.io/r/graphics/plot.default.html) function. In
  addition, the data used to create the plot is made available to the
  user, so it is possible to use other libraries such as ggplot2.
...
- Basándose en el paquete
  ...
  tratamientos) o con un modelo (creado con
  [`lm()`](https://rdrr.io/r/stats/lm.html) o
  [`aov()`](https://rdrr.io/r/stats/aov.html)). En el segundo caso, se
  debe indicar el nombre de la variable con los tratamientos a comparar.
...
- Por defecto, se grafica un dendrograma. El dendrograma puede ser
  personalizado con cualquier argumento de la función
  [`plot()`](https://rdrr.io/r/graphics/plot.default.html). Además, el
  usuario tiene acceso a los datos usados para crearlo, por lo que es
...
![Example with dgc test](reference/figures/README-example1-1.png)
...
![Example with jolliffe test](reference/figures/README-example2-1.png)
...
[`plot()`](https://rdrr.io/r/graphics/plot.default.html) function. In
the case of the lines, arguments for the
[`abline()`](https://rdrr.io/r/graphics/abline.html) function must be
passed as list. For a detailed explanation and examples, check
[`vignette("CustomPlots")`](https://sgs2000.github.io/ClustMC/articles/CustomPlots.md).

🇪🇸 Los dendrogramas pueden ser personalizados, utilizando cualquier
argumento disponible para la función
[`plot()`](https://rdrr.io/r/graphics/plot.default.html). En el caso de
las líneas rectas, se debe utilizar una lista conteniendo argumentos
para la función [`abline()`](https://rdrr.io/r/graphics/abline.html).
Para ver una explicación detallada y ejemplos, revise
[`vignette("CustomPlots")`](https://sgs2000.github.io/ClustMC/articles/CustomPlots.md).
